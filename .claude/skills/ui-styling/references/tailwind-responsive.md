...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
  <div class="bg-white rounded-sm shadow p-6">Card 1</div>
  <div class="bg-white rounded-sm shadow p-6">Card 2</div>
  <div class="bg-white rounded-sm shadow p-6">Card 3</div>
  <div class="bg-white rounded-sm shadow p-6">Card 4</div>
</div>
```
...
<section class="py-12 md:py-20 lg:py-32">
  <div class="container mx-auto px-4">
    <div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
      ...
      <div class="flex-1">
        <img src="hero.jpg" class="w-full rounded-sm" />
      </div>
    </div>
  </div>
</section>
