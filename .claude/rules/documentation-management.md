...
- **Project Roadmap** (`.claude/docs/development-roadmap.md`): Living document tracking project phases, milestones, and progress
- **Project Changelog** (`.claude/docs/project-changelog.md`): Detailed record of all significant changes, features, and fixes
- **System Architecture** (`.claude/docs/architecture.md`): Overall architecture, data flow, module patterns
- **Code Standards** (`.claude/docs/conventions.md`): Naming conventions, TypeScript rules, component patterns
