            ...
            >
              ...
              <div className='space-y-2'>
                ...
                <div className={`flex h-12 rounded border ${variant.value === 'inset' ? 'bg-muted' : 'bg-background'}`}>
                  ...
                  <div className={`w-3 shrink-0 bg-muted flex flex-col gap-0.5 p-1 ${variant.value === 'floating' ? 'border-r m-1 rounded' : variant.value === 'inset' ? 'm-1 ms-0 rounded bg-muted/80' : 'border-r'}`}>
                  ...
                  <div className={`flex-1 ${variant.value === 'inset' ? 'bg-background ms-0' : 'bg-background/50'} m-1 rounded-sm border-dashed border border-muted-foreground/20`}></div>
                </div>
              </div>
            </div>
          ))}
