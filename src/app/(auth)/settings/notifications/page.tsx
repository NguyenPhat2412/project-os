                    ...
                    render={({ field }) => (
                      <FormItem className='flex items-center space-x-3'>
                        ...
                        <div className='space-y-1'>
                          ...
                          <p className='text-sm text-muted-foreground'>Get notified when there are security events on your account.</p>
                        </div>
                      </FormItem>
                    )}
                  />
                    ...
                    render={({ field }) => (
                      <FormItem className='flex items-center space-x-3'>
                        ...
                        <div className='space-y-1'>
                          ...
                          <p className='text-sm text-muted-foreground'>Receive emails about our latest offers and promotions.</p>
                        </div>
                      </FormItem>
                    )}
                  />
